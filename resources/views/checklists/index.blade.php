...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('checklist.create') }}" class="btn btn-primary float-right">Tambah Checklist</a>
        </div>
        <div class="card-body">
            <!-- Tombol untuk pengelompokan -->
            <div class="mb-3">
                <a href="{{ route('checklist.index', ['group' => 'kategori']) }}" class="btn btn-info">Kelompokkan Berdasarkan
                    Kategori</a>
                <a href="{{ route('checklist.index', ['group' => 'jenis_kendaraan']) }}"
                    class="btn btn-secondary">Kelompokkan Berdasarkan Jenis Kendaraan</a>
            </div>
            <!-- Tabel Checklist -->
                    ...
                    @forelse ($groupedChecklists as $groupKey => $groupedItems)
                        ...
                        @foreach ($groupedItems as $key => $checklist)
                            <tr>
                                ...
                                <td>{{ ['sebelum' => 'Sebelum', 'setelah' => 'Setelah', 'test_jalan' => 'Test Jalan', 'test_pompa' => 'Test Pompa', 'lain-lain' => 'Lain-lain'][$checklist->kategori] }}
                                </td>
