            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item {{ request()->query('jenis') === 'utama' ? 'bg-dark' : '' }}">
                            <a href="{{ route('pemeriksaan.create', ['jenis' => 'utama']) }}" class="nav-link">
                                <i class="nav-icon bi bi-ev-front-fill"></i>
                                <p>Kendaraan Utama</p>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->query('jenis') === 'pendukung' ? 'bg-dark' : '' }}">
                            <a href="{{ route('pemeriksaan.create', ['jenis' => 'pendukung']) }}" class="nav-link">
                        ...
                        {{-- <li class="nav-item {{ request()->query('jenis') === 'pendukung' ? 'bg-dark' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('view-pdf*') ? 'bg-dark' : '' }}">
                                <a href="{{route('view.showpdf')}}" class="nav-link">
